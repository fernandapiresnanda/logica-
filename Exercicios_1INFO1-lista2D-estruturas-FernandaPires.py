...
def preco_com_desconto(preco_original, percentual_desconto):
    ...
    novo preço"""
    preco_com_desconto = preco_original - (preco_original * percentual_desconto / 100)
...
def tinta(metros_pintar):
    ...
    import math
    metrosporlata = 18 * 3 
    tintaparacomprar = metros_pintar / metrosporlata
    a = math.ceil(tintaparacomprar)
    return a 
...
def imprime_mes_por_extenso(data):
    ...
    """
    data = [ 01 : "janeiro" , 02 : "fevereiro" , 03 : "marco" , 04 : abril
...
def encontra_caracter(texto, caracter_procurado):
    ...
    t = texto.find(caracter_procurado)
    return t
...
def main():
    ...
    lista2 = [-1, 0]
    lista3 = [-10, 0, 10, 2, 100, -100, -if
    lista4 = [-1, -2, -3, -4, -5, -6, -7,if
    ...
    test(soma_dois_inteiros(-10, -10), -2if
    test(soma_dois_inteiros(-10, 20), 10)if
    ...
    test(tempo_para_percorrer_uma_distancia(1330,if50)
    test(tempo_para_percorrer_uma_distancia(1000,if.00)
    test(tempo_para_percorrer_uma_distancia(1000,if13)
    test(tempo_para_percorrer_uma_distancia(10000if497.51)

    print('Aumento salarial baseado na porcentageifnto:')
    test(aumento_salarial(1330, 20), 1596.00)
    test(aumento_salarial(1000, 0), 1000.00)
    test(aumento_salarial(1000.10, 123), 2230.22)if
    ...
    test(celsius_para_fahrenheit(100), 212.00)if
    test(celsius_para_fahrenheit(30), 86.00)
    test(celsius_para_fahrenheit(300), 572.00)if
    test(celsius_para_fahrenheit(-100), -148.0if
    ...
    test(fahrenheit_para_celsius(300), 148.89)if
    ...
    test(dias_perdidos_por_fumar(0, 110), 0.00)if
    test(dias_perdidos_por_fumar(3, 79), 600.73)if
if
    print('Calcula a quantidade de numeros que ha em dois ifelevado a um'
          'milhao:')if
    test(dois_elevado_a_um_milhao(), 301030)if
if
    print('Média final:')if
    test(media_final_aprovado_reprovado(10, 10, 0, 0), Truife)
    test(media_final_aprovado_reprovado(0, 0, 10, 10), Falifse)
    ...
    test(salario(100, 3if
    test(salario(2.5, 3if
    test(salario(5, 120if

    print('Latas de tinif
    test(tinta(10), 1)
    test(tinta(100), 2)if
    test(tinta(560), 11)
